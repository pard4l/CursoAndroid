...
import static treinamento.mobi.app.CommonUtilities.displayMessage;
...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    protected void onRegistered(Context context, String registrationId) {
        ...
        //ServerUtilities.register(context, "Treinamento.Mobi", "flaviano@treinamentos.mobi", registrationId);
    }
    ...
    private static void generateNotification(Context context, String message) {
        ...
        notificationIntent.putExtra("vimDoNotificacao", true);
