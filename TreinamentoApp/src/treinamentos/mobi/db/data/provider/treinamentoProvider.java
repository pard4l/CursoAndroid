...
import treinamentos.mobi.db.data.provider.treinamentoContent.Person;
 ...
 * By Flaviano
 */
public final class treinamentoProvider extends ContentProvider {

    private static final String LOG_TAG = treinamentoProvider.class.getSimpleName();

    /* package */ static final boolean ACTIVATE_ALL_LOGS = false;

    protected static final String DATABASE_NAME = "treinamentoProvider.db";

    public static final String AUTHORITY = "treinamentos.mobi.db.provider.treinamentoProvider";
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            Log.d(LOG_TAG, "Creating treinamentoProvider database");
