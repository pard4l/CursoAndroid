...
public abstract class treinamentoContent {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://" + treinamentoProvider.AUTHORITY);
    ...
    public static final class Person extends treinamentoContent {
        ...
        public static final Uri CONTENT_URI = Uri.parse(treinamentoContent.CONTENT_URI + "/" + TABLE_NAME);
